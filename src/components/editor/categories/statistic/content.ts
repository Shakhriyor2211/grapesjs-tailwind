export const statistic_contents = {
  statistic_1: `<div class="flex flex-wrap -m-4 text-center">
  ...
  statistic_2: `<div class="flex flex-wrap">
      <div
  ...
  statistic_3: `<div class="flex flex-col text-center w-full mb-20">
      <h1

export const testimonial_contents = {
  testimonial_1: `<h1 class="text-3xl font-medium title-font text-gray-900 mb-12 text-center">
      Testimonials
    </h1>
        ...
        <div class="h-full bg-gray-100 p-8 rounded">
          ...
          <a class="inline-flex items-center"
            ...
            /><span class="flex-grow flex flex-col pl-4"
              ...
              ><span class="text-gray-500 text-sm">UI DEVELOPER</span></span
            ></a
          >
        </div>
      </div>
        ...
        <div class="h-full bg-gray-100 p-8 rounded">
          ...
          <a class="inline-flex items-center"
            ...
            /><span class="flex-grow flex flex-col pl-4"
              ><span class="title-font font-medium text-gray-900"
                >Alper Kamu</span
              ><span class="text-gray-500 text-sm">DESIGNER</span></span
            ></a
          >
        </div>
      </div>
    </div>`,
  testimonial_2: `    <div class="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
      <svg
        fill="currentColor"
  ...
  testimonial_3: `   <div class="flex flex-col text-center w-full mb-20">

export const gallery_contents = {
  gallery_1: `<div class="flex w-full mb-20 flex-wrap">
      <h1
  ...
  gallery_2: `    <div class="lg:w-2/3 mx-auto">
      ...
      <div class="flex flex-wrap space-y-4 sm:space-y-0 -mx-2">
  ...
  gallery_3: `<div class="flex flex-col text-center w-full mb-20">
      <h1

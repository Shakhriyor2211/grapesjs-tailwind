export const team_contents = {
  team_1: `<div class="flex flex-col text-center w-full mb-20">
      <h1
  ...
  team_2: `<div class="flex flex-col text-center w-full mb-20">
      <h1
  ...
  team_3: `<div class="flex flex-col text-center w-full mb-20">
